...
function love.conf(t)
    ...
    t.window.title = "GCF"         -- The window title (string)
    ...
    t.window.x = 5                    -- The x-coordinate of the window's position in the specified display (number)
    t.window.y = 36                   -- The y-coordinate of the window's position in the specified display (number)
